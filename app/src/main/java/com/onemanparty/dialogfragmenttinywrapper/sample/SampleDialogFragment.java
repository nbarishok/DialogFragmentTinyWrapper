...
public class SampleDialogFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDelegate = new ConfirmDialogFragmentDelegate<>("sample_dialog", mListener, R.string.sample_dialog_title, R.string.sample_dialog_subtitle, R.string.sample_dialog_ok, R.string.sample_dialog_cancel);
